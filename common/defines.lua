...
NGame = {
	...
	MAX_COLONIAL_NATIONS = 90,				-- Max is 100
...
NDiplomacy = {
	...
	JOIN_HRE_DEVELOPMENT_CAP_VASSAL = 500,			-- Max cap of development of vassals to join the empire
	...
	HRE_VOTE_SAME_CULTURE_GROUP = 20,
...
NCountry = {
	...
	STATE_MAINTENANCE_DEV_FACTOR = 0.009,		-- per dev
	...
	MIN_TECH_FOR_CIRCUMNAVIGATE = 15,			-- Must have this level of dip tech to circumnavigate the globe
	CIRCUMNAVIGATION_PROVINCE_1 = 196,			-- Provinces for circumnavigation (coast of gambia)
	CIRCUMNAVIGATION_PROVINCE_2 = 181,			-- Provinces for circumnavigation (magellan strait)
	CIRCUMNAVIGATION_PROVINCE_3 = 341,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_4 = 267,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_5 = 406,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_6 = 256,			-- Provinces for circumnavigation (cape of good hope)
	...
	FREE_IDEA_GROUP_COST  = 7,						-- modifier on cheapness of "free" idea group
	...
	TECH_TIME_COST = 0.6,			-- tech grow with 20% cost over time.
	...
	REBEL_ARTILLERY_INCREASE_LEVEL_2_TECH = 36,		-- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE is applied
	...
	SETTLMENT_GROWTH_CHANCE_MIN = 0.00, -- Minimum chance of increasing development for colonists promoting Settlement Growth
...
NMilitary = {
	...
	BASE_MP_TO_MANPOWER = 0.075,		-- 75 men per manpower
	SIEGE_ATTRITION = 1,
	...
	CAV_REGIMENT_MANPOWER_COST = 0.5, 				-- 1 = 1000 men in cost.
	...
	TRANSPORT_COST = 24,							-- _MDEF_TRANSPORT_COST = 10,
	INFANTRY_TIME = 60, 							-- _MDEF_INFANTRY_TIME = 10,
	CAVALRY_TIME = 730, 								-- _MDEF_CAVALRY_TIME = 10,
	ARTILLERY_TIME = 120, 							-- _MDEF_ARTILLERY_TIME = 10,
	HEAVY_SHIP_TIME = 1460, 							-- _MDEF_HEAVY_SHIP_TIME = 10,
	...
	CAV_LOOT = 0.1,								-- How many ducats/month will a single full strength cavalry regiment loot?
	...
	FLAGSHIP_COST_SAILORS = 600,					-- The cost in sailors of a flagship
	FLAGSHIP_BUILDTIME = 1460,						-- Building time in days of a flagship
...
NAI = {
	...
	MAX_CAV_PERCENTAGE = 20, -- For modding, actual ratio is dynamically computed but will be no higher than this.
	...
	FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 32, -- Tech level at which AI will double its artillery fraction
	...
	STATE_MAINTENANCE_BUDGET_FRACTION = 0.25, -- AI will spend a maximum of this fraction of monthly income on state maintenance
	...
	REPAY_LOAN_BASE_AI_DESIRE = 6.0,							-- AI scoring for repaying loans, multiplied by (MAX(budget - other loans, 0) * number_of_loans)/cost
...
NAIEconomy = {
	...
	STATE_MAINTENANCE_FRACTION = 0.2,
	BASE_SAVINGS_PRIORITY = 0.5,
	BASE_SAVINGS_PRIORITY_WARTIME = 0.0,
	LOAN_REPAYMENT_SAVINGS_PRIORITY = 1.2,				-- Per loan
	LOAN_REPAYMENT_SAVINGS_PRIORITY_WARTIME = 0.6,		-- Per loan
